...
(function () {
  ...
  function injectCSS(){
    ...
    s.textContent = [
      ...
      ".bw-zg{display:flex;gap:28px;align-items:center;padding:18px 24px;background:var(--paper-raised);border:1px solid var(--line);border-radius:13px 10px 14px 9px / 10px 13px 9px 12px}",
      ...
      ".bw-zg-legend i.d-self{height:8px;width:8px;border:0;border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--terracotta)}",
      ".bw-zg-legend i.d-resp{height:8px;width:8px;border:0;border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--prussian)}",
      ".bw-zg-legend i.d-move{height:9px;width:9px;border:1.6px solid var(--terracotta);border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--paper-raised)}",
      ...
      ".bw-af-legend i.d-self{height:8px;width:8px;border:0;border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--terracotta)}",
      ".bw-af-legend i.d-resp{height:8px;width:8px;border:0;border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--prussian)}",
      ".bw-af-legend i.d-move{height:9px;width:9px;border:1.6px solid var(--terracotta);border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--paper-raised)}",
