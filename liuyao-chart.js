...
(function () {
  ...
  function injectCSS(){
    ...
    s.textContent=[
      ...
      ".lyc-casthead{display:flex;align-items:center;gap:13px;font-size:11px;letter-spacing:.14em;white-space:nowrap}",
      ...
      ".lyc-tag{font-size:9px;letter-spacing:.09em;color:var(--ghost);min-width:38px}",
      ...
      ".lyc-star i{font-style:normal;font-size:8.5px;letter-spacing:.04em;color:var(--ghost);margin-right:4px}",
      // figures
      ...
      ".lyc-tricap{font-size:9px;letter-spacing:.16em;color:var(--faint);padding:3px 5px}",
      ".lyc-fig.bian .lyc-tricap{text-align:left}",
      ".lyc-name{font-family:var(--sans);font-size:15px;font-weight:600;color:var(--ink);padding:5px 5px 0;letter-spacing:.01em}",
      ...
      ".lyc-lab .lyc-rel{font-family:var(--sans);font-size:13px;font-weight:600}",
      ...
      ".lyc-role{display:inline-block;font-size:8.5px;font-weight:600;letter-spacing:.03em;color:var(--dim);margin-left:6px;border:1px solid var(--line);border-radius:3px;padding:0 4px}",
      ...
      ".lyc-ssline i{font-style:normal;font-size:8px;letter-spacing:.03em;color:var(--prussian);border:1px solid color-mix(in oklab,var(--prussian) 30%,transparent);border-radius:3px;padding:0 3px}",
      // verdict
