...
(function () {
  ...
  function injectCSS(){
    ...
    s.textContent=[
      ...
      ".lyc-line{padding:4px 5px;border-radius:6px 4px 7px 3px / 4px 6px 3px 5px;cursor:pointer;transition:background .15s}",
      ...
      ".lyc-role{display:inline-block;font-size:8.5px;font-weight:600;letter-spacing:.03em;text-transform:uppercase;color:var(--dim);margin-left:6px;border:1px solid var(--line);border-radius:4px 2px 4px 3px / 3px 4px 2px 3px;padding:0 4px}",
      ...
      ".lyc-ssline i{font-style:normal;font-size:8px;letter-spacing:.03em;text-transform:uppercase;color:var(--prussian);border:1px solid color-mix(in oklab,var(--prussian) 30%,transparent);border-radius:4px 2px 4px 3px / 3px 4px 2px 3px;padding:0 3px;cursor:help}",
      // verdict + readout
      ...
      ".lyc-vbadge{font-family:var(--serif);font-size:12.5px;padding:2px 11px;border:1px solid var(--ink);border-radius:44% 56% 60% 40% / 63% 41% 55% 37%;color:var(--ink)}",
      ".lyc-vtiming{font-size:11px;color:var(--faint)}",
      ".lyc-readout{margin-top:9px;padding:9px 12px;background:var(--paper);border:1px solid var(--line-soft);border-radius:10px 7px 11px 6px / 7px 10px 6px 9px;min-height:46px}",
