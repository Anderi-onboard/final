...
(function () {
  ...
  ".castings{margin-top:22px;flex:1;min-height:0;display:flex;flex-direction:column;gap:1px;overflow-y:auto;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:rgba(42,32,22,.22) transparent}" +
  ...
  ".castings .lbl{flex:none;padding:0 8px 7px;font-family:'Rubik';font-weight:900}" +
  ...
  ".ledger-head .lbl{font-family:'Rubik';font-size:10px;font-weight:600;letter-spacing:.13em;text-transform:uppercase;color:var(--faint)}" +
  ".ledger-plan{font-family:'Rubik';font-size:9px;font-weight:600;letter-spacing:.11em;text-transform:uppercase;color:var(--terracotta);background:rgba(181,80,44,.1);border:1px solid rgba(181,80,44,.22);border-radius:999px;padding:3px 9px}" +
  ".ledger-bal{display:flex;align-items:baseline;gap:6px;margin-top:10px}" +
  ".ledger .count{font-family:'IBM Plex Mono',monospace;font-weight:600;font-size:30px;line-height:1;color:var(--ink);font-variant-numeric:tabular-nums;letter-spacing:-.02em}" +
  ".ledger-unit{font-family:'Rubik';font-size:10px;font-weight:600;letter-spacing:.14em;text-transform:uppercase;color:var(--faint)}" +
  ...
  ".ledger-cap{margin-top:7px;font-family:'Rubik';font-size:10px;letter-spacing:.03em;color:var(--ghost)}" +
  ".exchange{margin-top:13px;display:flex;align-items:center;justify-content:center;gap:7px;width:100%;border:none;background:var(--terracotta);color:var(--paper);border-radius:10px;padding:9px;font-family:'Rubik';font-weight:600;font-size:12px;letter-spacing:.04em;box-shadow:0 2px 10px rgba(181,80,44,.25);transition:transform .15s,background .15s,box-shadow .15s}" +
  ...
  ".side-foot b{display:block;font-size:13px;font-weight:700;font-family:'Raleway'}" +
  ".side-foot i{font-style:normal;font-size:11px;letter-spacing:.04em;color:var(--ghost);font-family:'Rubik'}" +
  ...
  ".acct-menu.open{display:flex;animation:acctPop .18s cubic-bezier(.4,0,.2,1)}" +
  ...
  ".acct-menu .who b{font-size:15px;font-weight:400;font-family:'Sawarabi Mincho',serif;display:block;color:var(--ink);line-height:1.3}" +
  ".acct-menu .who span{font-size:10.5px;color:var(--ghost);font-family:'IBM Plex Mono',monospace;letter-spacing:.01em;margin-top:3px;display:block}" +
  ...
  ".mi.plan b{margin-left:auto;font-size:9px;font-weight:500;letter-spacing:.1em;color:var(--terracotta);border:1px solid rgba(181,80,44,.32);border-radius:5px;padding:2px 7px;font-family:'IBM Plex Mono',monospace;text-transform:uppercase}";
  ...
  aside.innerHTML =
    ...
    '<a class="new-cast" href="./index.html">' +
      ...
      '<span class="fade" style="font-family: Merriweather; font-weight: 900">New inquiry</span>' +
    '</a>' +
    ...
    '<div class="acct-menu" id="acctMenu">' +
      '<div class="who"><b style="font-family: &quot;Bree Serif&quot;">Guest</b><span style="font-family: &quot;Bree Serif&quot;">Sign in to maintain your history and unit balance</span></div>' +
      '<a class="mi plan" href="./pricing.html" style="font-family: &quot;Bree Serif&quot;"><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M8 1.5l2 4.2 4.5.6-3.3 3.1.8 4.5L8 11.7l-4 2.2.8-4.5L1.5 6.3l4.5-.6z"></path></svg>Plan &amp; units<b id="miPlanBadge">BASIC</b></a>' +
      '<a class="mi" href="./settings.html" style="font-family: &quot;Bree Serif&quot;"><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="8" cy="8" r="2.5"></circle><path d="M8 1.5v2M8 12.5v2M1.5 8h2M12.5 8h2M3.4 3.4l1.4 1.4M11.2 11.2l1.4 1.4M12.6 3.4l-1.4 1.4M4.8 11.2l-1.4 1.4"></path></svg>Settings</a>' +
      '<button class="mi" id="miSignout" style="font-family: &quot;Bree Serif&quot;"><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M6 2.5H3.5v11H6M10 5l3 3-3 3M13 8H6.5"></path></svg>Sign out</button>' +
    '</div>';
