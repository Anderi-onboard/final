...
(function () {
  ...
  ".ledger:hover{transform:translateY(-2px)}" +
  ".ledger::before{content:'';position:absolute;inset:-30px;z-index:-1;pointer-events:none;background:linear-gradient(158deg,rgba(244,233,210,.22) 0%,rgba(235,221,194,.07) 52%,rgba(244,233,210,.2) 100%);backdrop-filter:blur(18px) saturate(1.2);-webkit-backdrop-filter:blur(18px) saturate(1.2);animation:organicLedger 18s ease-in-out infinite;-webkit-mask-image:linear-gradient(to bottom,transparent 0,#000 60px,#000 calc(100% - 60px),transparent 100%),linear-gradient(to right,transparent 0,#000 60px,#000 calc(100% - 60px),transparent 100%);mask-image:linear-gradient(to bottom,transparent 0,#000 60px,#000 calc(100% - 60px),transparent 100%),linear-gradient(to right,transparent 0,#000 60px,#000 calc(100% - 60px),transparent 100%);-webkit-mask-composite:source-in;mask-composite:intersect}" +
  "@keyframes organicLedger{0%,100%{border-radius:16px 13px 15px 11px / 12px 16px 11px 14px}14%{border-radius:14px 18px 10px 16px / 16px 10px 17px 12px}28%{border-radius:18px 10px 16px 12px / 11px 17px 12px 18px}42%{border-radius:11px 16px 18px 10px / 18px 12px 10px 16px}56%{border-radius:16px 11px 12px 17px / 10px 18px 16px 11px}70%{border-radius:12px 16px 17px 10px / 14px 11px 15px 17px}84%{border-radius:17px 10px 11px 15px / 12px 16px 10px 14px}}" +
  ...
  ".ledger-plan{font-family:'Spinnaker';font-size:9px;font-weight:600;letter-spacing:.11em;text-transform:uppercase;color:var(--pine);background:rgba(61,92,74,.1);border:1px solid rgba(61,92,74,.24);border-radius:999px;padding:3px 9px}" +
  ...
  ".side-foot{position:relative;margin-top:12px;display:flex;align-items:center;gap:10px;padding:9px 10px;cursor:pointer;text-align:left;width:100%}" +
  ".side-foot::before{content:'';position:absolute;inset:-18px;z-index:-1;pointer-events:none;background:linear-gradient(158deg,rgba(244,233,210,.22) 0%,rgba(235,221,194,.07) 52%,rgba(244,233,210,.2) 100%);backdrop-filter:blur(16px) saturate(1.2);-webkit-backdrop-filter:blur(16px) saturate(1.2);animation:organicSideFoot 16s ease-in-out infinite;-webkit-mask-image:linear-gradient(to bottom,transparent 0,#000 36px,#000 calc(100% - 36px),transparent 100%),linear-gradient(to right,transparent 0,#000 36px,#000 calc(100% - 36px),transparent 100%);mask-image:linear-gradient(to bottom,transparent 0,#000 36px,#000 calc(100% - 36px),transparent 100%),linear-gradient(to right,transparent 0,#000 36px,#000 calc(100% - 36px),transparent 100%);-webkit-mask-composite:source-in;mask-composite:intersect;transition:background .15s}" +
  ".side-foot:hover::before{background:linear-gradient(158deg,rgba(244,233,210,.32) 0%,rgba(235,221,194,.15) 52%,rgba(244,233,210,.3) 100%)}" +
  "@keyframes organicSideFoot{0%,100%{border-radius:11px 9px 10px 8px / 8px 11px 7px 9px;backdrop-filter:blur(16px) saturate(1.2);-webkit-backdrop-filter:blur(16px) saturate(1.2)}20%{border-radius:9px 12px 7px 11px / 11px 7px 12px 8px;backdrop-filter:blur(20px) saturate(1.28);-webkit-backdrop-filter:blur(20px) saturate(1.28)}40%{border-radius:12px 7px 11px 8px / 7px 12px 8px 12px;backdrop-filter:blur(13px) saturate(1.14);-webkit-backdrop-filter:blur(13px) saturate(1.14)}60%{border-radius:8px 11px 12px 7px / 12px 8px 7px 11px;backdrop-filter:blur(21px) saturate(1.3);-webkit-backdrop-filter:blur(21px) saturate(1.3)}80%{border-radius:11px 8px 8px 10px / 8px 11px 7px 9px;backdrop-filter:blur(14px) saturate(1.16);-webkit-backdrop-filter:blur(14px) saturate(1.16)}}" +
  ...
  ".mi.plan b{margin-left:auto;font-size:9px;font-weight:500;letter-spacing:.1em;color:var(--pine);border:1px solid rgba(61,92,74,.36);border-radius:5px;padding:2px 7px;font-family:'Spinnaker';text-transform:uppercase}" +
  "@media (prefers-reduced-motion: reduce){.ledger::before{animation:none;border-radius:16px}.side-foot::before{animation:none;border-radius:11px}}";
