...
(function () {
  ...
  "@keyframes organicSideFoot{0%,100%{border-radius:11px 9px 10px 8px / 8px 11px 7px 9px}20%{border-radius:9px 12px 7px 11px / 11px 7px 12px 8px}40%{border-radius:12px 7px 11px 8px / 7px 12px 8px 12px}60%{border-radius:8px 11px 12px 7px / 12px 8px 7px 11px}80%{border-radius:11px 8px 8px 10px / 8px 11px 7px 9px}}" +
