...
(function () {
  ...
  ".ledger::before{content:'';position:absolute;inset:-45px;z-index:-1;pointer-events:none;background:linear-gradient(158deg,rgba(244,233,210,.22) 0%,rgba(235,221,194,.07) 52%,rgba(244,233,210,.2) 100%);backdrop-filter:blur(10px) saturate(1.2);-webkit-backdrop-filter:blur(10px) saturate(1.2);animation:organicLedger 18s ease-in-out infinite;-webkit-mask-image:linear-gradient(to bottom,transparent 0,#000 90px,#000 calc(100% - 90px),transparent 100%),linear-gradient(to right,transparent 0,#000 90px,#000 calc(100% - 90px),transparent 100%);mask-image:linear-gradient(to bottom,transparent 0,#000 90px,#000 calc(100% - 90px),transparent 100%),linear-gradient(to right,transparent 0,#000 90px,#000 calc(100% - 90px),transparent 100%);-webkit-mask-composite:source-in;mask-composite:intersect}" +
  ...
  ".side-foot::before{content:'';position:absolute;inset:-28px;z-index:-1;pointer-events:none;background:linear-gradient(158deg,rgba(244,233,210,.22) 0%,rgba(235,221,194,.07) 52%,rgba(244,233,210,.2) 100%);backdrop-filter:blur(9px) saturate(1.2);-webkit-backdrop-filter:blur(9px) saturate(1.2);animation:organicSideFoot 16s ease-in-out infinite;-webkit-mask-image:linear-gradient(to bottom,transparent 0,#000 56px,#000 calc(100% - 56px),transparent 100%),linear-gradient(to right,transparent 0,#000 56px,#000 calc(100% - 56px),transparent 100%);mask-image:linear-gradient(to bottom,transparent 0,#000 56px,#000 calc(100% - 56px),transparent 100%),linear-gradient(to right,transparent 0,#000 56px,#000 calc(100% - 56px),transparent 100%);-webkit-mask-composite:source-in;mask-composite:intersect;transition:background .15s}" +
  ...
  "@keyframes organicSideFoot{0%,100%{border-radius:11px 9px 10px 8px / 8px 11px 7px 9px;backdrop-filter:blur(9px) saturate(1.2);-webkit-backdrop-filter:blur(9px) saturate(1.2)}20%{border-radius:9px 12px 7px 11px / 11px 7px 12px 8px;backdrop-filter:blur(11px) saturate(1.28);-webkit-backdrop-filter:blur(11px) saturate(1.28)}40%{border-radius:12px 7px 11px 8px / 7px 12px 8px 12px;backdrop-filter:blur(8px) saturate(1.14);-webkit-backdrop-filter:blur(8px) saturate(1.14)}60%{border-radius:8px 11px 12px 7px / 12px 8px 7px 11px;backdrop-filter:blur(12px) saturate(1.3);-webkit-backdrop-filter:blur(12px) saturate(1.3)}80%{border-radius:11px 8px 8px 10px / 8px 11px 7px 9px;backdrop-filter:blur(8px) saturate(1.16);-webkit-backdrop-filter:blur(8px) saturate(1.16)}}" +
  ...
  "backdrop-filter:blur(12px) saturate(1.55);-webkit-backdrop-filter:blur(12px) saturate(1.55);" +
