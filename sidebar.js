...
(function () {
  ...
  ".ledger .count{font-family:Spinnaker, monospace;font-weight:600;font-size:30px;line-height:1;color:var(--ink);font-variant-numeric:tabular-nums;letter-spacing:-.02em}" +
  ...
  ".acct-menu .who span{font-size:10.5px;color:var(--ghost);font-family:Spinnaker, monospace;letter-spacing:.01em;margin-top:3px;display:block}" +
  ...
  ".mi.plan b{margin-left:auto;font-size:9px;font-weight:500;letter-spacing:.1em;color:var(--terracotta);border:1px solid rgba(181,80,44,.32);border-radius:5px;padding:2px 7px;font-family:Spinnaker, monospace;text-transform:uppercase}";
