...
(function () {
  ...
  ".brand-home{display:flex;align-items:center;gap:8px;border-radius:8px 6px 9px 5px / 6px 8px 4px 7px;transition:opacity .15s}" +
  ...
  ".side-toggle{margin-left:auto;width:30px;height:30px;flex:none;display:grid;place-items:center;border-radius:8px 6px 9px 5px / 6px 8px 4px 7px;color:var(--faint);transition:background .15s,color .15s}" +
  ...
  ".new-cast{margin-top:16px;display:flex;align-items:center;gap:10px;padding:7px 8px;border-radius:9px 6px 10px 5px / 6px 9px 5px 8px;font-size:14px;color:var(--terracotta);font-weight:500;transition:background .15s;text-align:left}" +
  ".new-cast:hover{background:var(--paper-dim)}" +
  ".new-cast .ic{flex:none;width:24px;height:24px;border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--terracotta);color:var(--paper);display:grid;place-items:center}" +
  ...
  ".casting{flex:none;display:block;width:100%;text-align:left;font-size:13px;color:var(--dim);padding:6px 8px;border-radius:8px 6px 9px 5px / 6px 8px 4px 7px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;transition:background .15s,color .15s}" +
  ".casting:hover{background:var(--paper-dim);color:var(--ink)}" +
  ".hist-empty{margin:2px 8px;padding:13px 12px;border:1px dashed var(--line);border-radius:10px 7px 11px 6px / 7px 10px 6px 9px;font-size:12px;line-height:1.5;color:var(--faint);white-space:normal}" +
  "body.rail .castings{opacity:0;pointer-events:none}" +
  ".ledger{position:relative;margin-top:14px;flex:none;overflow:hidden;background:linear-gradient(150deg,rgba(244,233,210,.72),rgba(244,233,210,.5));backdrop-filter:blur(13px) saturate(1.3);-webkit-backdrop-filter:blur(13px) saturate(1.3);border:1px solid rgba(255,255,255,.45);border-radius:18px 13px 20px 12px / 13px 18px 11px 16px;padding:13px 14px 14px;box-shadow:0 6px 20px rgba(31,29,26,.12),inset 0 1px 0 rgba(255,255,255,.5);transition:transform .22s cubic-bezier(.4,0,.2,1),box-shadow .18s,border-color .18s}" +
  ...
  ".ledger-plan{font-family:'Spinnaker';font-size:9px;font-weight:600;letter-spacing:.11em;text-transform:uppercase;color:var(--terracotta);background:rgba(181,80,44,.1);border:1px solid rgba(181,80,44,.22);border-radius:44% 56% 60% 40% / 63% 41% 55% 37%;padding:3px 9px}" +
  ...
  ".exchange{margin-top:13px;display:flex;align-items:center;justify-content:center;gap:7px;width:100%;border:none;background:var(--terracotta);color:var(--paper);border-radius:11px 8px 12px 7px / 8px 11px 7px 10px;padding:9px;font-family:'Spinnaker';font-weight:600;font-size:12px;letter-spacing:.04em;box-shadow:0 2px 10px rgba(181,80,44,.25);transition:transform .15s,background .15s,box-shadow .15s}" +
  ...
  ".side-foot{position:relative;margin-top:12px;display:flex;align-items:center;gap:10px;padding:9px 10px;border-radius:12px 9px 13px 8px / 9px 12px 8px 11px;cursor:pointer;text-align:left;width:100%;background:rgba(244,233,210,.5);border:1px solid var(--line-soft);backdrop-filter:blur(10px) saturate(1.2);-webkit-backdrop-filter:blur(10px) saturate(1.2);box-shadow:0 1px 4px rgba(31,29,26,.07),inset 0 1px 0 rgba(255,255,255,.32);transition:background .15s,border-color .15s}" +
  ".side-foot:hover{background:rgba(244,233,210,.82);border-color:var(--line)}" +
  ".avatar{flex:none;width:30px;height:30px;border-radius:47% 53% 61% 39% / 44% 51% 49% 56%;background:var(--prussian);color:#EAF1F8;display:grid;place-items:center;font-size:11.5px;font-weight:600}" +
  ...
  "border:1px solid rgba(255,255,255,.6);border-radius:15px 10px 16px 9px / 10px 15px 9px 13px;padding:6px;" +
  ...
  ".mi{display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:9px 6px 10px 5px / 6px 9px 5px 8px;font-size:13px;color:var(--dim);text-align:left;transition:background .15s,color .15s}" +
  ".mi:hover{background:rgba(42,32,22,.07);color:var(--ink)}" +
  ".mi.plan b{margin-left:auto;font-size:9px;font-weight:500;letter-spacing:.1em;color:var(--terracotta);border:1px solid rgba(181,80,44,.32);border-radius:6px 4px 7px 3px / 4px 6px 3px 5px;padding:2px 7px;font-family:'Spinnaker';text-transform:uppercase}";
