...
(function () {
  ...
  var CSS = ''
    ...
    /* ten ridges, ALL SYNCHRONISED to the same 36-stop timeline
       ...
       then crossfades to the next. These 36 palettes are user-supplied
       reference combinations (each already a genuine multi-hue mix,
       not one hue tinted/shaded) rather than named brand references.
       Each palette's 3-4 actual colours are densified into 10 ridge
       tones by adding tints/shades of those SAME colours (never a new
       hue), then ordered light-to-dark so the ridges still read as
       atmospheric perspective (hazy/far at the top, rich/near at the
       bottom) while keeping every one of the source colours intact.
       The 36 palettes, by dominant tones:
       Peach & steel blue, Periwinkle & navy, Aubergine & gold, Royal blue & cream, Slate & fawn, Cream & harbor blue, Powder blue & rosewood, Sky & teal, Midnight & apricot, Dove grey & linen, Frost & mist blue, Cerulean & marigold, Garnet & ember, Cornflower & rust, Honey & navy, Cobalt & tangerine, Fog & bronze, Heather & butter, Camel & powder, Linen & indigo, Umber & apricot, Marigold & plum, Parchment & cocoa, Navy & paprika, Ivory & cobalt, Lilac & violet, Navy & sand, Onyx & peach, Bone & jet, Powder & tan, Sienna & powder, Butter & cerulean, Navy & blush, Slate & cream, Charcoal & terracotta, Navy & wheat
       */
    + '@keyframes mtn-sys-l1{0%,100%{fill:#FCF3E9}2.778%{fill:#E9F0FB}5.556%{fill:#FBEFD4}8.333%{fill:#FBF5EA}11.111%{fill:#DDE0E2}13.889%{fill:#F7F3EE}16.667%{fill:#ECF1F9}19.444%{fill:#EAF1FB}22.222%{fill:#EFB77E}25%{fill:#F5F3F0}27.778%{fill:#F0F6F9}30.556%{fill:#E9F2FB}33.333%{fill:#EDE0C2}36.111%{fill:#EDE4D0}38.889%{fill:#FBF5E9}41.667%{fill:#EDCB93}44.444%{fill:#F0F2F5}47.222%{fill:#F9F4E6}50%{fill:#F8F5EC}52.778%{fill:#F6F3EF}55.556%{fill:#F0DAB8}58.333%{fill:#F2E3B2}61.111%{fill:#F8F4EC}63.889%{fill:#D99C5D}66.667%{fill:#F8F4EC}69.444%{fill:#F7F4ED}72.222%{fill:#F0DCC0}75%{fill:#F0DCC8}77.778%{fill:#F6F4EF}80.556%{fill:#EEF1F7}83.333%{fill:#C4D4E4}86.111%{fill:#FBF7E9}88.889%{fill:#F8EDED}91.667%{fill:#F7F4EE}94.444%{fill:#D8D8D4}97.222%{fill:#DCBF8E}}'
    + '@keyframes mtn-sys-l2{0%,100%{fill:#FBF3E9}2.778%{fill:#EAF0FB}5.556%{fill:#F8DD9F}8.333%{fill:#F5E3C4}11.111%{fill:#E8DDC3}13.889%{fill:#F6F3EE}16.667%{fill:#F0F4FA}19.444%{fill:#EAF2FA}22.222%{fill:#A0A3C3}25%{fill:#DEE0E1}27.778%{fill:#EDF3F8}30.556%{fill:#EEF5FC}33.333%{fill:#E3CB94}36.111%{fill:#B9D8EB}38.889%{fill:#F4DFBB}41.667%{fill:#9EA5CF}44.444%{fill:#F0F2F4}47.222%{fill:#F5EBD0}50%{fill:#F7F2E6}52.778%{fill:#F7F6F2}55.556%{fill:#E9C287}58.333%{fill:#ECD280}61.111%{fill:#F8F4ED}63.889%{fill:#E0B052}66.667%{fill:#F8F4ED}69.444%{fill:#F9F6F1}72.222%{fill:#DEC8A4}75%{fill:#E7C099}77.778%{fill:#F7F6F2}80.556%{fill:#F1F4F8}83.333%{fill:#E2C297}86.111%{fill:#EDF2F8}88.889%{fill:#F2D8D8}91.667%{fill:#F2ECE2}94.444%{fill:#E3C09E}97.222%{fill:#E0C088}}'
    + '@keyframes mtn-sys-l9{0%,100%{fill:#2E6C9E}2.778%{fill:#13318C}5.556%{fill:#1A2A4B}8.333%{fill:#0A185D}11.111%{fill:#8B7B6E}13.889%{fill:#152238}16.667%{fill:#2B6E73}19.444%{fill:#2B7080}22.222%{fill:#262342}25%{fill:#9FA8B0}27.778%{fill:#AAB8C4}30.556%{fill:#1859B3}33.333%{fill:#5C0A0A}36.111%{fill:#4D3A2B}38.889%{fill:#1B2C4C}41.667%{fill:#E07516}44.444%{fill:#181F2A}47.222%{fill:#C89132}50%{fill:#92ABC0}52.778%{fill:#1C2438}55.556%{fill:#4A1F14}58.333%{fill:#2A2438}61.111%{fill:#3A2418}63.889%{fill:#8A2D11}66.667%{fill:#101830}69.444%{fill:#866BC3}72.222%{fill:#21354B}75%{fill:#25252F}77.778%{fill:#181818}80.556%{fill:#A87C50}83.333%{fill:#5B2E11}86.111%{fill:#5C8CC0}88.889%{fill:#243F64}91.667%{fill:#293546}94.444%{fill:#2A3146}97.222%{fill:#293246}}'
    + '@keyframes mtn-sys-l10{0%,100%{fill:#1E4F76}2.778%{fill:#0B1F5C}5.556%{fill:#0A1222}8.333%{fill:#091845}11.111%{fill:#705F51}13.889%{fill:#060B13}16.667%{fill:#1A494C}19.444%{fill:#1B4D58}22.222%{fill:#100F1E}25%{fill:#C7B283}27.778%{fill:#5E81A0}30.556%{fill:#1E3F8C}33.333%{fill:#460A08}36.111%{fill:#2A1F16}38.889%{fill:#0B1424}41.667%{fill:#2B44B9}44.444%{fill:#090C11}47.222%{fill:#9F7123}50%{fill:#D2B076}52.778%{fill:#090C13}55.556%{fill:#371B0C}58.333%{fill:#100D17}61.111%{fill:#130B07}63.889%{fill:#1C2848}66.667%{fill:#040B15}69.444%{fill:#8068B0}72.222%{fill:#1C2C4C}75%{fill:#0C0C10}77.778%{fill:#0D0C0C}80.556%{fill:#B38737}83.333%{fill:#4C2418}86.111%{fill:#3B70A9}88.889%{fill:#1C2440}91.667%{fill:#1C2840}94.444%{fill:#141824}97.222%{fill:#1C2840}}'
    ...
    /* fill is a PAINT property: animating it forces a full re-raster of these huge ridge
       ...
       repaints. IMPORTANT: steps(N) must be >= the number of colour stops (36) — fewer
       steps than stops lands most sampled frames on a browser-interpolated BLEND between
       two palettes instead of a clean one, which reads as muddy/mixed. steps(36) gives
       each of the 36 palettes its own clean, unblended hold (~4s each @ 144s total) with
       one jump every 4s. translate flows stay GPU-composited regardless. */
    + '.mtn-bg .fill{animation-iteration-count:infinite;animation-timing-function:steps(36)}'
    ...
    + '.mtn-bg .l1{animation-name:mtn-sys-l1;animation-duration:144s;animation-delay:0s;opacity:.48}'
    + '.mtn-bg .l2{animation-name:mtn-sys-l2;animation-duration:144s;animation-delay:0s;opacity:.60}'
    + '.mtn-bg .l3{animation-name:mtn-sys-l3;animation-duration:144s;animation-delay:0s;opacity:.72}'
    + '.mtn-bg .l4{animation-name:mtn-sys-l4;animation-duration:144s;animation-delay:0s;opacity:.83}'
    + '.mtn-bg .l5{animation-name:mtn-sys-l5;animation-duration:144s;animation-delay:0s;opacity:.90}'
    + '.mtn-bg .l6{animation-name:mtn-sys-l6;animation-duration:144s;animation-delay:0s;opacity:.95}'
    + '.mtn-bg .l7{animation-name:mtn-sys-l7;animation-duration:144s;animation-delay:0s;opacity:.97}'
    + '.mtn-bg .l8{animation-name:mtn-sys-l8;animation-duration:144s;animation-delay:0s;opacity:1}'
    + '.mtn-bg .l9{animation-name:mtn-sys-l9;animation-duration:144s;animation-delay:0s;opacity:1}'
    + '.mtn-bg .l10{animation-name:mtn-sys-l10;animation-duration:144s;animation-delay:0s;opacity:1}'
